    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm font-light" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
            {isLogin 
        ...
        <div className="space-y-6">
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 border border-gray-800 bg-transparent hover:bg-gray-900/50 text-white rounded-lg transition-all duration-200 hover:scale-[1.02]" 
            style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}
          >
          ...
          <div className="text-center pt-6">
            ...
            <button 
              ...
              className="text-white hover:text-gray-300 text-sm font-medium transition-colors duration-200 underline underline-offset-4"
              style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}
            >
